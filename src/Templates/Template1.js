...
import TemplateObjective from "../Components/TemplateObjective";
...
const Template1 = (props) => {
  ...
  return (
    <Paper
      ...
      />
      <Container>
        <TemplateHeading color={"#C98A55"} title={"Objective"} />
          <ul style={{ marginBottom: 10, marginLeft:-14}}>
            <TemplateObjective objective={personalinfo.objective} />
          </ul>
